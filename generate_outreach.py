...
9. ABSOLUTELY NO em-dashes (—). Use commas, periods, or "and" instead. Zero tolerance.
10. No ** or excessive formatting. Clean, simple text only
11. Reference their background naturally. Mention past companies, education, expertise without being creepy
12. Write full sentences with "I" as subject. Don't drop pronouns to sound punchy.
    BAD: "Heading to DCAT next week..."  GOOD: "I'll be at DCAT next month..."
    BAD: "Saw your progress on..."  GOOD: "I noticed your progress on..."
...
"I saw your post about CMC partner challenges. The 'too small for big CDMOs, too risky for unproven ones' dilemma is real, and it's exactly the gap we built Rezon Bio to fill. Worth comparing notes? I'm in Boston next month."
